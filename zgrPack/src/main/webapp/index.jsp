...
<div id="top" style="border:0px solid red">
  ...
  <div style="border:0px solid red;height:350px">
     <img src="img/1111.png" height="350" width="100%"/>
  </div>
...
<div class="box980">
   <div class="box680">
     <div id="slide6" class="hotBrand">
			<div id="slideTit6" class="titBar b-titBar">
				<strong>包装盒设计</strong>
				<a title="瑞士手表品牌" href="/brands_link.html" class="more">更多包装盒设计&gt;&gt;</a>
			</div>
            <div class="brandName" id="marquee0">
            	<p>
            		<dl>
            			<dt>
            				<a href="product/productList.jsp" title="礼盒包装">
            					<img src="img/20160505091500_9687.jpg" alt="礼盒包装" width="88" height="88" border="0">
           					</a>
        				</dt>
						<dd>
							<a title="礼盒包装" href="#">礼盒包装</a>
						</dd>
            		</dl>
            		<dl>
            			<dt>
            				<a href="product/productList.html" title="天梭手表">
            					<img src="images/brandlogo/tissot.jpg" alt="天梭" width="88" height="38" border="0">
            				</a>
           				</dt>
						<dd>
							<a title="天梭手表" href="#">天梭</a>
						</dd>
